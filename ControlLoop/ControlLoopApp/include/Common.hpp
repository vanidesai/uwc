...
public:
	...
	/**
	 * Get Write Request Delay
	 * @param None
	 * @return Write Request Delay
	 */
	const int getStrWRDelay() const {
		return m_strWRDelay;
	}

	/**
	 * Set Write Request Delay
	 * @param strReadRequest :[in] Write Request Delay
	 * @return None
	 */
	void setStrWRDelay(int strWRDelay) {
		m_strWRDelay = strWRDelay;
	}
