...
{
	rm -rf UWC.tar.gz
	tar --exclude='docker-compose.yml' --exclude='modbus-master/bin'  --exclude='create_uwc_package.sh' --exclude='README.md' modbus-master/ MQTT/  mqtt-export/ Others/ docker-compose_DEV.yml -zcvf UWC.tar.gz
