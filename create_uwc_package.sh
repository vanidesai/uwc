...
createUWCPackage()
{
	...
	tar  --exclude='modbus-master/bin'  --exclude='Old_scripts.zip' --exclude='create_uwc_package.sh' --exclude='README.md' modbus-master/ MQTT/  mqtt-export/ scada-rtu/ Others/ *.yml uwc_common/ -zcvf UWC.tar.gz 
