...
typedef enum StackErrorCode
{
	...
	STACK_ERROR_SERIAL_PORT_ERROR,
	STACK_ERROR_SERIAL_PORT_ALREADY_IN_USE,
	STACK_ERROR_PORT_NAME_LENGTH_EXCEEDED,
	STACK_ERROR_INVALID_BAUD_RATE,
	STACK_ERROR_MAX=60
}eStackErrorCode;
